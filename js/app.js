...
$('#click').click(function(){ $('.free, .four, #click-2').show(); $('.one, .two, #click').hide(); });
$('#click-2').click(function(){ $('.four, #last, #click-3').show(); $('#click-2, .free').hide(); });
$('#click-3').click(function(){ $('.one, .two, #click').show(); $('#click-3, .four, #last').hide(); });
